...
export default function CareersPage(){return <main><SiteHeader /><PageHero eyebrow="Careers" title="Be part of something big—" accent="and be big in it." image="/team2.png" alt="Cummins Worldwide team outside the Clearwater office" unoptimized />
