...
export default function CareersPage(){return <main><SiteHeader /><PageHero eyebrow="Careers" title="Be part of something big—" accent="and be big in it." image="/careers.png" alt="Cummins Worldwide leadership" />
