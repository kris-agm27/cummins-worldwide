...
export default function CareersPage(){return <main><SiteHeader />
  <style>{".page-hero-image{min-height:0!important;height:auto;aspect-ratio:3/2}.page-hero-image img{object-fit:contain!important;object-position:center center!important;background:#f5f1e8}@media(min-width:1001px){.page-hero-with-image{min-height:0;align-items:stretch}.page-hero-image{margin-left:-2px;width:calc(100% + 2px)}.page-hero-with-image .page-hero-copy{padding:3.5rem 5vw}.page-hero-with-image .page-hero-copy h1{font-size:clamp(3.8rem,6vw,6.8rem)}}"}</style>
