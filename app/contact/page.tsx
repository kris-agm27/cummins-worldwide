...
export default function ContactPage(){return <main><SiteHeader /><PageHero eyebrow="Contact Cummins Worldwide" title="Let's build what" accent="comes next." />
  <section className="contact-form-section" id="contact-form">
    ...
    <form className="inquiry-form" action="https://formsubmit.co/admin@agmagency.com" method="POST">
      ...
      <p className="form-note">After submitting, you&apos;ll receive an automatic confirmation and our team will be notified. The first submission may require a one-time activation by the site administrator.</p>
    </form>
  </section>
